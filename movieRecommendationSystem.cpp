...
public:
    ...
    void addToFavorite(const string &movieName)
    {
        ...
        setTextColor(3);
        cout << endl
             << "Movie \"" << movieName << "\" added to favorites.\n";
    }
    ...
    void removeFromFavorite()
    {
        if (count == 0)
        {
            setTextColor(3);
            cout << endl
                 << "Favorites list is empty. Nothing to remove.\n";
            return;
        }
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            if (queue[index] == movieName)
            {
                found = true;
                cout << endl
                     << "Movie \"" << movieName << "\" removed from favorites.\n";
        ...
        {
            cout << endl
                 << "Movie \"" << movieName << "\" not found in favorites.\n";
        }
    }
